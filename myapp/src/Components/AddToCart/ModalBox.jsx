    ...
    return (
        <>
            <div style={{paddingInline:'5%'}} className="fixed top-0 left-0 flex items-center z-20 justify-center w-full h-screen backdrop-brightness-50 backdrop-blur-[2px] bg-opacity-40">
                <div className='w-full gap-3 sm:w-[60%] md:w-fit lg:w-[37vw] p-6 flex flex-col justify-between fle relative rounded-md border-2 shadow-2xl bg-white h-fit'>
                    <div>
                        ...
                        <div className='sm:flex-row flex flex-col w-full gap-3'>
                            ...
                            <div className='flex w-full justify-between flex-row'>
                                <div className='flex pt-3 flex-col'>
                                    ...
                                    <p className='text-xl font-medium'>{storeItem && storeItem.category}</p>
                                    <p className='text-xl font-semibold'>${storeItem && storeItem.price}</p>
                                </div>
