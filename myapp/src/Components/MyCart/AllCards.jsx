...
const AllCards = () => {
    ...
    return (
        <div className='flex sm:px-[4%] mt-10 flex-col md:flex-row w-full justify-center gap-5'>
            {
                selectItems && selectItems.length === 0 ? (
                    ...
                    <div className=' flex-col flex md:flex md:flex-col lg:flex-row w-full justify-center gap-6'>
